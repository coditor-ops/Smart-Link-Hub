    ...
    <div className="bg-void text-white min-h-screen overflow-x-hidden selection:bg-neon/30 antialiased font-body relative">
      ...
      <nav className="fixed top-0 w-full z-50 bg-black/40 backdrop-blur-xl border-b border-white/5">
        <div className="flex justify-between items-center px-8 py-4 max-w-7xl mx-auto">
          <Link to="/" className="text-2xl font-black tracking-tighter text-transparent bg-clip-text kinetic-gradient font-headline">
            LinkHub
          </Link>
          ...
          <div className="hidden md:flex gap-8 items-center">
            ...
            <a href="#solutions" className="text-on-surface-variant font-medium hover:text-neon transition-all duration-300 tracking-tight">
              Solutions
            </a>
            <a href="#pricing" className="text-on-surface-variant font-medium hover:text-neon transition-all duration-300 tracking-tight">
              Pricing
            </a>
            <a href="#company" className="text-on-surface-variant font-medium hover:text-neon transition-all duration-300 tracking-tight">
              Company
            </a>
          </div>

          <div className="flex items-center gap-6">
            <Link to="/login" className="text-[#d1c1d9] font-medium hover:text-[#dfb7ff] transition-all duration-300 active:scale-95">
              Login
            </Link>
            <Link 
              to="/register"
              className="kinetic-gradient text-white px-6 py-2 rounded-lg font-bold hover:scale-105 transition-all text-center flex items-center justify-center shadow-neon-glow"
            >
              Get Started
            </Link>
          </div>
        ...
        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <h1 className="text-5xl md:text-7xl font-bold text-white tracking-tight font-headline leading-[1.1] h-auto">
              ...
              <GlassCard className="w-full max-w-[500px] overflow-hidden border-neon/20 bg-void/40 backdrop-blur-md">
                ...
                <div className="p-8 font-mono text-sm space-y-3">
                  ...
                  <div className="flex gap-4">
                    ...
                    <span><span className="text-neon">if</span> (request.device === <span className="text-primary-fixed">{"'mobile'"}</span>):</span>
                  </div>
                  <div className="flex gap-4">
                    <span className="text-gray-500 select-none">02</span>
                    <span className="pl-6">redirect_to(<span className="text-secondary-fixed">{"'/app/ios-store'"}</span>)</span>
                  </div>
                  <div className="flex gap-4">
                    <span className="text-gray-500 select-none">03</span>
                    <span><span className="text-neon">elif</span> (request.region === <span className="text-primary-fixed">{"'EU'"}</span>):</span>
                  </div>
                  <div className="flex gap-4">
                    <span className="text-gray-500 select-none">04</span>
                    <span className="pl-6">apply_gdpr_routing(<span className="text-secondary-fixed">{"'/eu-node'"}</span>)</span>
                  </div>
                  <div className="flex gap-4">
                  ...
                  <div className="flex gap-4">
                    ...
                    <span className="pl-6">use_default_gateway(<span className="text-secondary-fixed">{"'/global'"}</span>)</span>
                  </div>
                </div>
              </GlassCard>
            </FloatWrapper>
      ...
      <footer className="py-16 border-t border-white/5 bg-void">
        <div className="max-w-7xl mx-auto px-6">
          <p className="text-center text-gray-700 text-[10px] sm:text-[12px] uppercase tracking-[0.3em] font-medium scale-y-110">
            © {new Date().getFullYear()} Smart Link Hub. Kinetic Digital Architecture. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
